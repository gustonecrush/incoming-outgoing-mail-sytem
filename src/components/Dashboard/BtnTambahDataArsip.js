...
function BtnTambahDataArsip({ fetchSurat, active, api }) {
    ...
    const submitForm = e => {
        ...
        axios
            .post(`http://localhost:8000/api/${api}`, arsip, {
        ...
        Toast.fire({
            icon: 'success',
            title: 'Berhasil mengupload peminjaman arsip!',
        })
        ...
        <>
            ...
            {isOpen && (
                <div
                    ...
                    <div className="relative p-4 w-full max-w-3xl  h-full md:h-auto mt-[170px]">
...
export default BtnTambahDataArsip
